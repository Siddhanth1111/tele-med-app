    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
      ...
      {message && (
        <div className="max-w-7xl mx-auto px-6 pt-6">
          ...
          } border px-4 py-3 rounded-lg flex items-center gap-3 animate-fade-in`}>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-24">
              ...
              <div className="text-center mb-6 pb-6 border-b border-gray-200">
                <div className="relative inline-block mb-4">
                  <div className="w-24 h-24 bg-gradient-to-br from-blue-600 to-teal-600 rounded-full flex items-center justify-center text-3xl font-bold text-white shadow-lg">
              ...
              {activeTab === 'details' && (
                <form onSubmit={handleUpdateProfile} className="space-y-6">
                  ...
                  {profile.role === 'DOCTOR' && profile.doctorProfile && (
                    <div className="pt-6 border-t border-gray-200 mt-6">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                          <h4 className="text-xl font-bold text-gray-900">Professional Details</h4>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input 
                            ...
                            className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition text-gray-900"
                          />
                        </div>
                        <div>
                  ...
                  <div className="flex justify-end pt-6">
                    <button 
                      type="submit"
                      className="px-8 py-3 bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white font-semibold rounded-lg shadow-lg transition transform hover:scale-105"
                    >
                      Save Changes
                    </button>
                  </div>
