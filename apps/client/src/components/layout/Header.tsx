          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <>
                ...
                >
                  <div className="w-8 h-8 bg-gradient-to-br from-teal-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-lg">
                ...
                <button
                  onClick={logout}
                  className="px-4 py-2 text-red-400 hover:bg-red-500/10 rounded-lg font-medium transition"
                >
                  Logout
                </button>
              </>
              ...
              <>
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-600 hover:to-blue-700 text-white rounded-lg font-semibold shadow-lg transition transform hover:scale-105"
                >
                  Sign Up
                </button>
              </>
